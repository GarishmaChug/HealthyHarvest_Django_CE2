"""
Django settings for Evaluation2 project.
...
WSGI_APPLICATION = 'Evaluation2.wsgi.application'
...
LOGIN_URL = '/login/'  # should match your URL pattern name